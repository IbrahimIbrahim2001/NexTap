...
import BetterAuthLogo from "@/public/companies/better-auth-logo.png"
                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">Meet NexTap: Modern Customer Engagement</span>
                                ...
                                <TextEffect
                                    ...
                                    The Collaborative Hub for Modern Customer Engagement.
                                </TextEffect>
                                <TextEffect
                                    per="line"
                                    preset="fade-in-blur"
                                    ...
                                    Powerful collaborative editing tools that enable your team to deliver modern customer engagement experiences.
                                </TextEffect>
                                ...
                                <AnimatedGroup
                                    ...
                                    <div
                                        ...
                                        <Button
                                            ...
                                            <Link href="signup">
                                                <span className="text-nowrap">Join Us today</span>
                                            </Link>
                                        </Button>
                                    </div>
                                </AnimatedGroup>
                ...
                <section className="bg-background pb-16 pt-16 md:pb-32">
                    <div className="group relative m-auto max-w-5xl px-6">
                        ...
                        <div className="group-hover:blur-xs mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14">
                            ...
                            <div className="flex">
                                <Image
                                    className="mx-auto h-5 w-24 dark:invert"
                                    src={VercelLogo}
                                    alt="Vercel Logo"
                                    height="20"
                                    width="20"
